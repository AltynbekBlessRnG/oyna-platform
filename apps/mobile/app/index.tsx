...
import { CalendarDays, ListFilter, MapPin, Search } from "lucide-react-native";
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, eyebrow: { color: colors.muted, fontSize: 10, fontWeight: "800", letterSpacing: 1.5 }, location: { marginTop: 5, flexDirection: "row", alignItems: "center", gap: 6 }, city: { color: colors.text, fontSize: 17, fontWeight: "800" }, iconButton: { width: 42, height: 42, borderRadius: 14, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, alignItems: "center", justifyContent: "center" },
